...
import '@/app/styles/project-visualization.scss';
                ...
                <div key={member.id} className="resource-item">
                  <div className="member-info">
                    ...
                    <div className="member-details">
                      <h4>{member.name}</h4>
                      <p>{member.taskCount} {member.taskCount === 1 ? 'task' : 'tasks'}</p>
                    </div>
                  </div>
                  ...
                  <div className="workload-info">
                    <div className="workload-stats">
                      ...
                      <span className="project-count">{member.projectCount} {member.projectCount === 1 ? 'project' : 'projects'}</span>
                    </div>
                  </div>
                </div>
              ))}
